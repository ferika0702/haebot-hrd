...
<main class="p-md-3 p-2">
    ...
    <div class="row mt-4">
        <div class="col-md-4">
            <a class="text-decoration-none" href="<?= base_url() ?>user-group-view">
        ...
        <div class="col-md-4">
            <a class="text-decoration-none" href="<?= base_url() ?>user-permission-view">
                <div class="card mb-3 shadow" style="border: 1px solid #1762A5;">
        ...
        <div class="col-md-4">
            <a class="text-decoration-none" href="<?= base_url() ?>group-permission-view">
                <div class="card mb-3 shadow" style="border: 1px solid #1762A5;">
