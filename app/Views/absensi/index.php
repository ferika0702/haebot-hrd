        ...
        <table class="table table-hover table-striped table-bordered" width="100%" id="tabel">
            <thead>
                <tr>
                    ...
                    <th class="text-center" width="10%">Jam Masuk 1</th>
                    <th class="text-center" width="10%">Jam Masuk 2</th>
                    <th class="text-center" width="10%">Jam Masuk 3</th>
            ...
            <tbody>
                <?php $no = 1 ?>
                <?php foreach ($absensi as $karyawan) : ?>
                    <tr>
                        <td><?= $no++ ?></td>
                        <td><?= $karyawan['tanggal'] ?></td>
                        <td><?= $karyawan['nama_lengkap'] ?></td>
                        <td><?= $karyawan['masuk1'] ?></td>
                        <td><?= $karyawan['masuk2'] ?></td>
                        <td><?= $karyawan['masuk3'] ?></td>
    ...
    function confirm_delete(id) {
        Swal.fire({
            ...
            if (result.isConfirmed) {
                $('#form_delete').attr('action', '<?= site_url() ?>absensi/' + id);
                $('#form_delete').submit();
            }
        })
    }
