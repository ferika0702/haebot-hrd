...
<form autocomplete="off" class="row g-3 mt-2" action="<?= site_url() ?>file-karyawan/update/<?=$file['id']?>" method="POST" enctype="multipart/form-data">
<div class="d-flex my-0">
        <div class="me-auto mb-1">
            <h3 style="color: #566573;">Tambah File Karyawan <?= ucwords(strtolower($karyawan_name))?></h3>
        </div>
        <div class="me-2 mb-1">
            <a class="btn btn-sm btn-outline-dark mb-3" href="<?= site_url() ?>file-karyawan/<?=$id_karyawan?>">
