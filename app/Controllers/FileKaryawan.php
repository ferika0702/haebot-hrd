...
class FileKaryawan extends ResourceController
{
    ...
    public function index($id_karyawan=null)
    {
        ...
        return view('karyawan/file_karyawan/index',$data);
    }
    ...
    public function show($id = null)
    {
        if ($this->request->isAJAX()) {
            ...
            $json = [
                'data' => view('karyawan/file_karyawan/show', $data),
            ];
    ...
    public function new($id_karyawan=null)
    {
        ...
        return view('karyawan/file_karyawan/add',$data);
    }
    ...
    public function create()
    {
            ...
            if (!$this->validate($validasi)) {
                return redirect()->to('file-karyawan/new/'.$this->request->getPost('id_karyawan'))->withInput();
            }
            else {
                $modelFileKaryawan = new FileKaryawanModel();
                ...
                return redirect()->to('file-karyawan/'.$this->request->getPost('id_karyawan'));
            }
    }
    ...
    public function edit($id = null,$id_karyawan=null)
    {
        ...
        return view('karyawan/file_karyawan/edit',$data);
    }
    ...
    public function update($id = null)
    {
        ...
        if (!$this->validate($validasi)) {
            return redirect()->to('file-karyawan/edit/'.$id.'/'.$this->request->getPost('id_karyawan'))->withInput();
        }
        else {
            $modelFileKaryawan = new FileKaryawanModel();
            $file = $modelFileKaryawan->find($id);
